...
static const struct {
	...
	struct {
		...
		struct usb_endpoint_descriptor_no_audio sink_iso;
		struct usb_ss_ep_comp_descriptor sink_iso_comp;
		struct usb_endpoint_descriptor_no_audio source_iso;
		struct usb_ss_ep_comp_descriptor source_iso_comp;
	} ss_descs;
	...
	.fs_descs = {
		...
		.sink_iso = {
			...
			.wMaxPacketSize = cpu_to_le16(512) | (0x0 << 11),
	...
	.ss_descs = {
		...
		.sink_iso = {
			.bLength = sizeof descriptors.ss_descs.sink_iso,
			.bDescriptorType = USB_DT_ENDPOINT,
			.bEndpointAddress = 3 | USB_DIR_IN,
			.bmAttributes = USB_ENDPOINT_XFER_ISOC,
		...
		.sink_iso_comp = {
			...
			.bMaxBurst = 15,
			.bmAttributes = 0,
			.wBytesPerInterval = 1024 * 16,
		},
		.source_iso = {
			.bLength = sizeof descriptors.ss_descs.source_iso,
			.bDescriptorType = USB_DT_ENDPOINT,
			.bEndpointAddress = 4 | USB_DIR_OUT,
			.bmAttributes = USB_ENDPOINT_XFER_ISOC,
			.wMaxPacketSize = cpu_to_le16(1024),
